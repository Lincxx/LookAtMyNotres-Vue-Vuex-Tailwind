<template>
  <div class="bg-white w-1/2 m-4 rounded-lg shadow p-4 mx-auto">
    <label class="block">
    ...
    <label class="block mt-4">
      ...
      <textarea
        v-model="content"
        class="form-textarea mt-1 block w-full text-black"
        rows="3"
        placeholder="The content of my super cool note"
      ></textarea>
    </label>
    <div class="buttons w-full flex justify-center">
      ...
      <button
        v-if="!edit"
        class="bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded mt-4 mr-4 flex-grow"
        @click="add"
      >
        Add
      </button>
